...
This profile is derived from the [US Core Condition Encounter Diagnosis Profile](https://hl7.org/fhir/us/core/STU9/StructureDefinition-us-core-condition-encounter-diagnosis.html). Within the Personal Functioning and Engagement Condition Encounter Diagnosis profile, the asserter data element has been elevated to must support. This data element is a reference to an instance of Practitioner, PractitionerRole, Patient, or RelatedPerson. In addition, the US Core Encounter profile may reference a Personal Functioning and Engagement Condition Encounter Diagnosis Profile via its diagnosis data element. 