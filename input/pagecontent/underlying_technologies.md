...
This implementation guide supports the [R4]({{site.data.fhir.path}}index.html) version of the FHIR standard and builds on the [US Core STU5.0.1 Implementation Guide](http://hl7.org/fhir/us/core/STU5.0.1/); implementers need to familiarize themselves with the profiles in that guide.