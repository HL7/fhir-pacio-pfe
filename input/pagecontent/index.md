...
- FHIR Artifacts: These sections provide detailed descriptions and formal definitions for all the FHIR objects defined in this IG.
    ...
    - [Search Parameters](artifacts.html): This section lists the set of Search Parameters defined in this IG to support search functionality. E.
    - [Profiles](artifacts.html): This section lists the set of Profiles defined in this IG to exchange functioning information. Each linked Profile page includes a narrative introduction and a formal definition.
    - [Extensions](artifacts.html): This section lists the set of Extensions defined in and used by the Profiles in this IG . Each linked Extension page includes a formal definition.
    - [Value Sets](artifacts.html): This section lists the value sets this IG defines.
    - [Concept Maps](artifacts.html): This section lists the Concept Maps this IG defines.
    - [Examples](artifacts.html): This section lists example instances associated with this IG.
