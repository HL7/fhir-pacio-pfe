...
his resource does not include intravenous (IV) nutrition, vitamin supplements, or mineral supplements -- these should be handled using the US Core IG’s Medication Request profile [US Core MedicationRequest](http://hl7.org/fhir/us/core/STU9/StructureDefinition-us-core-medicationrequest.html). 
...
This profile is derived from the [FHIR R4 base Nutrition Order](https://hl7.org/fhir/R4/nutritionorder.html) resource. Normally profiles in U.S. based implementation guides are derived from U.S. Core profiles, but an exception was made because no U.S. Core 9.0.0 Nutrition Order profile exists. 
