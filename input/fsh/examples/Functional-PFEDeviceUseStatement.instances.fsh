...
Instance: PFEIG-SNF-Adm-Mobility-UseOfDevice-RollingWalker
InstanceOf: PFEUseOfDevice
Description: "Example PFE Use of Device for rolling walker during SNF admission functional assessment"
* subject = Reference(PFEIG-patientBSJ1)
* status = #active
* device = Reference(PFEIG-CMS-Device-RollingWalker)
* recordedOn = "2020-07-11T16:32:00-05:00"
* source = Reference(PFEIG-Practitioner-RonMarble)
* derivedFrom[+] = Reference(PFEIG-FSC-SNF-Admission-Mobility-SelfCare-1)
