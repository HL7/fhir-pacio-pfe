...
Description:    "The purpose of this profile is to facilitate exchange of information related to a device request/order to support a patient’s personal functioning and engagement in a post-acute care (PAC) setting (e.g., skilled nursing facility). This profile is based on the FHIR [DeviceRequest](https://hl7.org/fhir/R4/devicerequest.html) resource; refer to this resource for scope and usage definitions."
...
* codeReference only Reference(PFEDevice)
